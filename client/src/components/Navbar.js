  ...
  return (
    <div className='navbar'>
      <div className="navbar_left">
        <div style={{textDecoration:"none",color:'white'}}  onClick={()=>routeChange('/')} >
          StreamEzy
        </div>
      </div>
      <div className="navbar_right">
          ...
          <div style={{textDecoration:"none"}} onClick={()=>routeChange('/profile')} >
            <div title="Profile" className="navbar_icons navbar_user">
                <i className="navbar_icons far fa-user-circle"></i>
            </div>
          </div>

          <div style={{textDecoration:"none"}} onClick={()=>routeChange('/login')} >
          ...
          <div style={{textDecoration:"none"}} onClick={()=>routeChange('/signup')}>
          ...
          <div  style={{textDecoration:"none"}} onClick={()=>routeChange('/')} >
          ...
          <div style={{textDecoration:"none"}}  onClick={()=>routeChange('/golive')} >
